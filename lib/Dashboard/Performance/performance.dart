...
import 'package:login_page/controller/get_performance_controller.dart';
...
class _PerformanceScreenState extends State<PerformanceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<GetPerformaceController>(
        init: GetPerformaceController(),
          builder: (getPerformanceObj) {
        return Stack(
          children: [
            Positioned(
              top: 0,
            ...
            Positioned(
                ...
                child: ListView.builder(
                    itemCount: getPerformanceObj.getPerformanceList.length,
                      ...
                      return Column(
                        children: [
                          PerformanceCustomContainer(
                            ...
                            date: DateFormat('dd-MM-yyyy').format(getPerformanceObj.getPerformanceList[index].createdAt) ?? "",
                            rankingOfTask:
                            items[index]["Ranking Of Task"].toString() ?? "",
                            comments: getPerformanceObj.getPerformanceList[index].comments ??
                                "",
                          )
                        ],
                      );
