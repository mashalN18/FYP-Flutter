...
import 'package:login_page/model/get_performance_success_response.dart';
...
class GetPerformaceController extends GetxController{
  bool isLoading = false;
  List<Datum> getPerformanceList = [];

  Future<bool> getPerformance() async {
    isLoading = true;
    update();
    dio.Response response =
    await ApiClient.getPerformance();

    isLoading = false;
    update();
    if (response.statusCode == HttpStatusCodes.OK) {
      String responseJson = json.encode(response.data);
    final getPerformanceSuccessResponse = getPerformanceSuccessResponseFromJson(responseJson);
      getPerformanceList = getPerformanceSuccessResponse.data;
